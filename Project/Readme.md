...
- Связность между VRF внутри ЦОД осуществляется через пограничный маршрутизатор и межсетевой экран.
- Связность между VRF Infrastructure разных ЦОД осуществляется через пограничные маршрутизаторы без участия межсетевого экрана.
- Связность между VRF Services разных ЦОД отсутствует.
- Доступ в Интернет в каждом ЦОД из всех VRF осущетсвляется только через межсетевой экран.
